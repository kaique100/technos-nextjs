...
function index({isOpen, setModalOpen}) {
                ...
                <article className='modal-container'>
                    <div className='modal'>
                        <section className='buttonFechar'>
                            <a onClick={setModalOpen}><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <section className='formulario'>
                            <form className='formModal' >
                                <h2>Cadastrar novo Prestador</h2>
                                ...
                                <input type="text" placeholder='Área de cobertura' />
